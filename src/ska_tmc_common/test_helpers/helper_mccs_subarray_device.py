...
class HelperMccsSubarrayDevice(HelperSubArrayDevice):
    ...
    def update_command_info(
        ...
        """
        self.logger.info(
            "Recording the command data for Mccs Subarray \
    ...
    def ClearCommandCallInfo(self) -> None:
        ...
        self.logger.info(
            "Clearing CommandCallInfo for Mccs Subarray simulators"
        )
    ...
    def SetDelay(self, value: int) -> None:
        """Update delay value"""
        self.logger.info(
            "Setting the Delay for MccsSubarray simulator to : %s",
            value,
        )
        self._delay = value
    ...
    def push_obs_state_event(self, obs_state: ObsState) -> None:
        ...
        self.logger.info(
            "Pushing change event for HelperMccsSubarrayDeviceObsState: %s",
            obs_state,
        )
