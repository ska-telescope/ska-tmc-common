...
class HelperDishDevice(HelperDishLNDevice):
    ...
    class InitCommand(SKABaseDevice.InitCommand):
        ...
        def do(self) -> Tuple[ResultCode, str]:
            ...
            # self._device.set_change_event("programTrackTable", True, False)
    ...
    def write_programTrackTable(self, value: list) -> None:
        ...
        # self.push_change_event("programTrackTable",
        # self._program_track_table)
        HelperDishDevice.programTrackTable = self._program_track_table
