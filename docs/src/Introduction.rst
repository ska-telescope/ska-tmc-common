...
**TangoClient**: Class that provides abstraction for Tango client APIs [depricated]

**TangoGroupClient**: Class that provides abstraction for Tango group APIs [depricated]

**TangoServerHelper**: Class that provides abstraction for Tango device server APIs [depricated]
